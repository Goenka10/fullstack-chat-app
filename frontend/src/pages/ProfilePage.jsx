...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen pt-16 md:pt-20 pb-6">
      <div className="max-w-3xl mx-auto p-3 sm:p-4 md:p-6">
        <div className="bg-white rounded-xl shadow-md p-4 sm:p-6 space-y-6 md:space-y-8">
          <div className="text-center">
            <h1 className="text-xl sm:text-2xl font-semibold text-indigo-600">My Profile</h1>
            <p className="mt-2 text-sm sm:text-base text-gray-600">Manage your account information</p>
          </div>
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="relative">
              <label 
                ...
                className="block w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-full overflow-hidden border-4 border-indigo-500 cursor-pointer"
              >
                <img
                ...
                `}>
                  <Camera className="h-6 w-6 sm:h-8 sm:w-8 md:h-10 md:w-10 text-white" />
                </div>
              </label>
          ...
          {/* User Information - Responsive spacing */}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="px-3 sm:px-4 py-2 sm:py-2.5 bg-gray-100 rounded-lg border w-full text-sm sm:text-base text-gray-700"
                  readOnly
                />
                <CheckCircle className="absolute right-2 sm:right-3 top-1/2 transform -translate-y-1/2 h-4 w-4 sm:h-5 sm:w-5 text-green-500" />
              </div>
          ...
          {/* Account Information - Responsive sizing */}
